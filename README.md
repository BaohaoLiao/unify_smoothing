...
However, for BERT we have an extra token [MASK] from pretraining. You need to remove the word embedding for [MASK]. To do this, run the script below before loading for training.
```
